...
- 把写作、润色、审校拆开处理
- 尽量减少 AI 幻觉和设定漂移
- 把单章正文稳定控制在可连载区间，默认不少于 4300 字，常规 4300 到 5000 字
...
- 让每一章都必须和上一章、下一章对得上，避免章节之间像不同提纲拼接，降低 AI 混乱
...
如果你已经发现“前一章和后一章几乎对不上”，优先补章节对齐模板，再继续写正文，不要直接让模型硬接。
