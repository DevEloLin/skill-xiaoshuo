...
18. 情绪高压段落允许局部失稳，优先允许短句、断句、不完整句、失手和嘴硬，禁止把所有爆点都修成完整、匀称、体面的标准稿
19. 角色对白必须带缺点和偏差，默认至少拆出 3 种以上说话层次，避免所有人都稳定、理性、克制、会总结
20. 章节必须兼顾推进和情绪回报，默认每章至少设置一个能让读者明显感到爽、疼、拉扯或反弹的兑现点
21. 连载节奏默认尽早给压力、中段升级、后段推进下一轮问题，避免长时间说明或空转
22. 角色设计默认要求“标签 + 魅力 + 代价”三件套，缺一项都容易只剩设定说明
...
19. 情绪爆点表：记录哪一章、哪一段需要爆开，谁失控，余波如何进入后文
20. 对白声线矩阵：记录每个核心角色的口头毛边、说话缺陷和最不可能说出的句型
21. 情绪价值板：记录本书、本卷、本章最值钱的情绪兑现点和共感来源
22. 冲突节奏板：记录章节和卷的冲突频率、升级节点和后果变化
23. 魅力角色表：记录角色标签、魅力来源、反差和代价
